...
export const COZY_LIBRARY_SEED: LibraryItem[] = [
  ...
  item('immortal-animals-connect', 'BUNTE_TUETE', 'Natur & Tiere', {
    text: 'Sortiert diese Tiere nach Höchstgeschwindigkeit — schnellstes zuerst.',
    textEn: 'Sort these animals by top speed — fastest first.',
    answer: 'Gepard, Pferd, Elefant, Weinbergschnecke', answerEn: 'Cheetah, Horse, Elephant, Snail',
    bunteTuete: {
      kind: 'order',
      items: ['Elefant', 'Gepard', 'Weinbergschnecke', 'Pferd'],
      itemsEn: ['Elephant', 'Cheetah', 'Snail', 'Horse'],
      correctOrder: [1, 3, 0, 2],
      criteria: 'nach Höchstgeschwindigkeit (schnellstes zuerst)',
      criteriaEn: 'by top speed (fastest first)',
      itemValues: ['40 km/h', '110 km/h', '0,05 km/h', '70 km/h'],
    },
    funFact: 'Der Gepard beschleunigt in unter 3 Sekunden auf 100 km/h — schneller als die meisten Sportwagen.',
  }),
  ...
  item('female-nobel-connect', 'BUNTE_TUETE', 'Wissenschaft', {
    text: 'Nennt die 5 klassischen Sinne des Menschen.',
    textEn: 'Name the 5 classic human senses.',
    answer: 'Sehen, Hören, Riechen, Schmecken, Tasten', answerEn: 'Sight, Hearing, Smell, Taste, Touch',
    bunteTuete: {
      kind: 'top5',
      answers: ['Sehen', 'Hören', 'Riechen', 'Schmecken', 'Tasten'],
      answersEn: ['Sight', 'Hearing', 'Smell', 'Taste', 'Touch'],
      aliases: [['Sicht', 'Sehsinn', 'Augen'], ['Gehör', 'Ohren'], ['Geruch', 'Geruchssinn', 'Nase'], ['Geschmack', 'Geschmackssinn', 'Zunge'], ['Berührung', 'Tastsinn', 'Fühlen', 'Haut']],
    },
    funFact: 'Neben den fünf klassischen Sinnen kennt die Wissenschaft heute weitere — etwa den Gleichgewichtssinn und die Temperaturwahrnehmung.',
  }),
  ...
  item('celeb-patents-connect', 'BUNTE_TUETE', 'Geschichte', {
    text: 'Wo steht das Kolosseum?',
    textEn: 'Where is the Colosseum?',
    answer: 'Rom, Italien', answerEn: 'Rome, Italy',
    bunteTuete: {
      kind: 'map',
      lat: 41.8902,
      lng: 12.4922,
      targetLabel: 'Kolosseum, Rom',
    },
    funFact: 'Das Kolosseum (eröffnet 80 n. Chr.) fasste bis zu 50.000 Zuschauer — für Gladiatorenkämpfe und sogar nachgestellte Seeschlachten.',
  }),
  ...
  item('aristotle-alexander', 'MUCHO', 'Geschichte', {
    ...
    correctOptionIndex: 2,
    funFact: 'Philipp II von Makedonien holte Aristoteles 343 v.Chr. an seinen Hof, um den 13-jährigen Alexander zu unterrichten. Drei Jahre lang lehrte er Philosophie, Politik, Naturwissenschaft, Medizin. Alexander trug zeitlebens einen Aristoteles-bearbeiteten Homer („Ilias") unter dem Kopfkissen — sein „Kriegs-Manual". Die Lehrer-Reihe: Sokrates → Platon → Aristoteles → Alexander.',
  }),
  item('best-selling-book-genre', 'MUCHO', 'Literatur', {
    text: 'Welches ist weltweit das meistverkaufte Belletristik-Genre?',
    textEn: 'Which is the worldwide best-selling fiction genre?',
    answer: 'Romance / Liebesroman',
    answerEn: 'Romance',
    ...
    correctOptionIndex: 2,
    funFact: 'Romance macht weltweit ~30-40% der Belletristik-Umsätze aus — das größte Genre überhaupt. In den USA wurden 2023 über 39 Millionen Romance-Bücher verkauft. Treiber: TikTok-„BookTok"-Community, BookTok-Stars wie Colleen Hoover. „It Ends with Us" hat sich allein 4 Mio mal verkauft. Krimi/Thriller folgt auf Platz 2.',
  }),
  item('second-biggest-sport', 'MUCHO', 'Sport', {
    ...
    correctOptionIndex: 0,
    funFact: 'Cricket hat weltweit ~2,5 Milliarden Fans — getragen vor allem von Indien (1+ Mrd!), Pakistan, Bangladesch, UK, Australien, Karibik. Fußball führt mit ~3,5 Mrd. Hockey (vor allem Feldhockey, Indien & Pakistan) liegt knapp dahinter auf Platz 3 mit ~2 Mrd. Basketball ~2,4 Mrd. Tennis ~1 Mrd.',
  }),
  item('tattoo-origin', 'MUCHO', 'Sprache & Etymologie', {
    text: 'Woher kommt der Name „Tattoo"?',
    textEn: 'Where does the word „Tattoo" come from?',
    answer: 'Polynesisch („tatau")',
    answerEn: 'Polynesian („tatau")',
    options: [
      'Polynesisch („tatau")',
      'Italienisch („tato")',
      'Englisch („tatter")',
  ...
  item('flags-no-red', 'BUNTE_TUETE', 'Geographie', {
    ...
    answer: 'Argentinien, Brasilien, Irland, Indien, Niger, Côte d\'Ivoire, Schweden, Finnland, Griechenland, Ukraine, Israel, Saudi-Arabien, Bhutan, Pakistan, Estland, Botswana, Bahamas, Kasachstan, Guatemala, Honduras, Nigeria, Jamaika, Lesotho, Salomonen, Mikronesien, Palau, St. Lucia, St. Vincent und die Grenadinen, Vatikanstadt, Marshallinseln, Zypern, Somalia, Curaçao, Uruguay, El Salvador, Barbados, Gabun, Bosnien und Herzegowina, Nauru, Kosovo',
    answerEn: 'Argentina, Brazil, Ireland, India, Niger, Côte d\'Ivoire, Sweden, Finland, Greece, Ukraine, Israel, Saudi Arabia, Bhutan, Pakistan, Estonia, Botswana, Bahamas, Kazakhstan, Guatemala, Honduras, Nigeria, Jamaica, Lesotho, Solomon Islands, Micronesia, Palau, Saint Lucia, Saint Vincent and the Grenadines, Vatican City, Marshall Islands, Cyprus, Somalia, Curaçao, Uruguay, El Salvador, Barbados, Gabon, Bosnia and Herzegovina, Nauru, Kosovo',
    bunteTuete: { kind: 'hotPotato' },
