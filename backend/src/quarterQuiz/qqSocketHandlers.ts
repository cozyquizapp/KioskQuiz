  ...
  io.on('connection', (socket) => {
    ...
    socket.on('qq:setAvatarSet', (payload: { roomCode: string; avatarSetId: string }, ack?: unknown) => {
      try {
        ...
        const allowed = ['cozy3d', 'cozyWolves', 'cozyParty', 'cozyQuirks', 'cozyQuirks2', 'all', 'cozyAnimals', 'cozyCast', 'halloween', 'christmas', 'pub', 'scifi', 'sport', 'tropical', 'fantasy', 'esc', 'cozyArena'];
