...
## 📝 Einzel-Prompts (v2.3 · watertight · copy-paste ready)
...
`/design-lab.html` → Abschnitt „Avatar-Prompts (v2.3 · copy-paste)".
...
**v2.2-Umstellung auf Ring-less-Workflow:**
- Generator liefert nur noch die **Figur auf weißem Quadrat mit
  Safe-Area**. Ring wird **programmatisch** im Design-Lab-Compositor
  drumrum gerechnet — exakte Hex-Farbe, exakte Dicke, exakte Position.
- Gewinn: Konsistenz über alle 8 Tiere. Aus einer Quelle lassen sich
  später mehrere Formate rendern (Badge mit Ring, Grid-Tile ohne Ring,
  Icon-only, Face-Crop).

**v2.3-Härtung „wasserfest" nach drittem Test-Render:**
- v2.2-Figuren hatten einen **flachen horizontalen Hoodie-Abschluss**
  mit weißem Rand darunter — dadurch passte der programmatische Ring
  nicht organisch zur Figur (Wolf-Logo-Referenz: Hoodie-Kante kurvt am
  Kreisbogen entlang, keine Lücke).
- Neue Formulierung **CIRCULAR BADGE COMPOSITION**: Figur ist explizit
  ein **Portrait-BUST für Kreis-Badge**. Hoodie-Kante + Schulter-Silhouette
  müssen seitlich nach oben kurven und dem unteren Kreisbogen folgen —
  *„The hoodie bottom is NEVER flat or horizontal"*.
- Silhouette füllt **92 %** der Bildfläche (inscribed circle). Ecken
  sind das einzige Weiß, das übrig bleibt — sitzen später außerhalb
  des Kreis-Frames.
- Explizite Negation: *„No watermark, no signature, no text, no letters,
  no logo marks, no second character"*.

### 1. Waschbär — Team Teal

```
Flat vector mascot illustration in the exact style of the "CozyWolf" brand logo. 3/4 view with the head clearly turned slightly to one side (NOT straight-on front-facing). Head and shoulders only. Cozy cartoon style with rounded soft shapes. Absolutely flat: no outlines, no gradients, no shading, no edge shadows, no rim lighting, no darker color lip at hoodie edges — only pure solid color fills. Both eyes are IDENTICAL and fully closed — each eye is a gentle symmetric curved line with a subtle upward lash tip at the outer corner. No visible pupils, no dots, no eyeballs, no open-eye elements on either side. Both eye shapes must mirror each other perfectly in size, position and curvature. Small peaceful closed-mouth smile. Character wears a chunky pullover HOODIE (NOT a coat, NOT a duffle coat, NO toggles, NO buttons, NO zippers) visible from shoulders down, with a soft rounded hood clearly visible as a fold of fabric lying flat behind the neck and shoulders. CIRCULAR BADGE COMPOSITION (critical): the character is framed as a head-and-chest portrait BUST designed to fit inside a circular badge — exactly like the CozyWolf wolf logo. The hoodie's bottom edge and the outer silhouette of the shoulders MUST curve upward at the sides to form a smooth arc that matches the lower half of an inscribed circle. The hoodie bottom is NEVER flat or horizontal — it tapers into a rounded curve whose sides rise along the circle's boundary. The character's face sits in the upper-center of the composition with a small amount of white air above the ears; the hoodie fills the lower-center and flows naturally into the circular frame. The entire character silhouette must fit inside an inscribed circle taking up the central 92 percent of the image (this circle will be the inner edge of a colored ring composited programmatically afterwards). Pure white background #FFFFFF throughout the entire square — the four corners of the square will be empty white and will sit outside the final circular frame. No ring, no circular frame, no border drawn in this image. No watermark, no signature, no text, no letters, no logo marks, no second character — single character only, centered. Highly saturated brand colors, do not desaturate, match hex codes exactly. Style must match the CozyWolf wolf logo as a sibling character. Square 1:1, 1024x1024. Raccoon character, saturated teal #14B8A6 fur, signature black bandit-mask across the eyes (still clearly visible even with the eyes closed), small rounded ears with teal inner fur, tiny black nose. Wearing amber-orange hoodie #F59E0B.
```

### 2. Faultier — Team Lime

```
Flat vector mascot illustration in the exact style of the "CozyWolf" brand logo. 3/4 view with the head clearly turned slightly to one side (NOT straight-on front-facing). Head and shoulders only. Cozy cartoon style with rounded soft shapes. Absolutely flat: no outlines, no gradients, no shading, no edge shadows, no rim lighting, no darker color lip at hoodie edges — only pure solid color fills. Both eyes are IDENTICAL and fully closed — each eye is a gentle symmetric curved line with a subtle upward lash tip at the outer corner. No visible pupils, no dots, no eyeballs, no open-eye elements on either side. Both eye shapes must mirror each other perfectly in size, position and curvature. Small peaceful closed-mouth smile. Character wears a chunky pullover HOODIE (NOT a coat, NOT a duffle coat, NO toggles, NO buttons, NO zippers) visible from shoulders down, with a soft rounded hood clearly visible as a fold of fabric lying flat behind the neck and shoulders. CIRCULAR BADGE COMPOSITION (critical): the character is framed as a head-and-chest portrait BUST designed to fit inside a circular badge — exactly like the CozyWolf wolf logo. The hoodie's bottom edge and the outer silhouette of the shoulders MUST curve upward at the sides to form a smooth arc that matches the lower half of an inscribed circle. The hoodie bottom is NEVER flat or horizontal — it tapers into a rounded curve whose sides rise along the circle's boundary. The character's face sits in the upper-center of the composition with a small amount of white air above the ears; the hoodie fills the lower-center and flows naturally into the circular frame. The entire character silhouette must fit inside an inscribed circle taking up the central 92 percent of the image (this circle will be the inner edge of a colored ring composited programmatically afterwards). Pure white background #FFFFFF throughout the entire square — the four corners of the square will be empty white and will sit outside the final circular frame. No ring, no circular frame, no border drawn in this image. No watermark, no signature, no text, no letters, no logo marks, no second character — single character only, centered. Highly saturated brand colors, do not desaturate, match hex codes exactly. Style must match the CozyWolf wolf logo as a sibling character. Square 1:1, 1024x1024. Sloth character, bright lime-green #84CC16 fur, slightly shaggy cheek tufts, rounded head, tiny dark nose, dreamy closed-eye smile. Wearing deep burgundy hoodie #7C2D12.
```

### 3. Pinguin — Team Blue

```
Flat vector mascot illustration in the exact style of the "CozyWolf" brand logo. 3/4 view with the head clearly turned slightly to one side (NOT straight-on front-facing). Head and shoulders only. Cozy cartoon style with rounded soft shapes. Absolutely flat: no outlines, no gradients, no shading, no edge shadows, no rim lighting, no darker color lip at hoodie edges — only pure solid color fills. Both eyes are IDENTICAL and fully closed — each eye is a gentle symmetric curved line with a subtle upward lash tip at the outer corner. No visible pupils, no dots, no eyeballs, no open-eye elements on either side. Both eye shapes must mirror each other perfectly in size, position and curvature. Small peaceful closed-mouth smile. Character wears a chunky pullover HOODIE (NOT a coat, NOT a duffle coat, NO toggles, NO buttons, NO zippers) visible from shoulders down, with a soft rounded hood clearly visible as a fold of fabric lying flat behind the neck and shoulders. CIRCULAR BADGE COMPOSITION (critical): the character is framed as a head-and-chest portrait BUST designed to fit inside a circular badge — exactly like the CozyWolf wolf logo. The hoodie's bottom edge and the outer silhouette of the shoulders MUST curve upward at the sides to form a smooth arc that matches the lower half of an inscribed circle. The hoodie bottom is NEVER flat or horizontal — it tapers into a rounded curve whose sides rise along the circle's boundary. The character's face sits in the upper-center of the composition with a small amount of white air above the ears; the hoodie fills the lower-center and flows naturally into the circular frame. The entire character silhouette must fit inside an inscribed circle taking up the central 92 percent of the image (this circle will be the inner edge of a colored ring composited programmatically afterwards). Pure white background #FFFFFF throughout the entire square — the four corners of the square will be empty white and will sit outside the final circular frame. No ring, no circular frame, no border drawn in this image. No watermark, no signature, no text, no letters, no logo marks, no second character — single character only, centered. Highly saturated brand colors, do not desaturate, match hex codes exactly. Style must match the CozyWolf wolf logo as a sibling character. Square 1:1, 1024x1024. Penguin character, saturated royal blue #2563EB body and head with a white belly/chest patch peeking above the hoodie collar, small orange beak, rounded head. Wearing bright sun-yellow hoodie #FDE047.
```

### 4. Kuh — Team Orange

```
Flat vector mascot illustration in the exact style of the "CozyWolf" brand logo. 3/4 view with the head clearly turned slightly to one side (NOT straight-on front-facing). Head and shoulders only. Cozy cartoon style with rounded soft shapes. Absolutely flat: no outlines, no gradients, no shading, no edge shadows, no rim lighting, no darker color lip at hoodie edges — only pure solid color fills. Both eyes are IDENTICAL and fully closed — each eye is a gentle symmetric curved line with a subtle upward lash tip at the outer corner. No visible pupils, no dots, no eyeballs, no open-eye elements on either side. Both eye shapes must mirror each other perfectly in size, position and curvature. Small peaceful closed-mouth smile. Character wears a chunky pullover HOODIE (NOT a coat, NOT a duffle coat, NO toggles, NO buttons, NO zippers) visible from shoulders down, with a soft rounded hood clearly visible as a fold of fabric lying flat behind the neck and shoulders. CIRCULAR BADGE COMPOSITION (critical): the character is framed as a head-and-chest portrait BUST designed to fit inside a circular badge — exactly like the CozyWolf wolf logo. The hoodie's bottom edge and the outer silhouette of the shoulders MUST curve upward at the sides to form a smooth arc that matches the lower half of an inscribed circle. The hoodie bottom is NEVER flat or horizontal — it tapers into a rounded curve whose sides rise along the circle's boundary. The character's face sits in the upper-center of the composition with a small amount of white air above the ears; the hoodie fills the lower-center and flows naturally into the circular frame. The entire character silhouette must fit inside an inscribed circle taking up the central 92 percent of the image (this circle will be the inner edge of a colored ring composited programmatically afterwards). Pure white background #FFFFFF throughout the entire square — the four corners of the square will be empty white and will sit outside the final circular frame. No ring, no circular frame, no border drawn in this image. No watermark, no signature, no text, no letters, no logo marks, no second character — single character only, centered. Highly saturated brand colors, do not desaturate, match hex codes exactly. Style must match the CozyWolf wolf logo as a sibling character. Square 1:1, 1024x1024. Cow character, bright orange #F97316 coat with a few irregular pure-white spot patches on the head, small pink muzzle, tiny rounded horns peeking out, floppy ears. Wearing deep plum hoodie #581C87.
```

### 5. Koala — Team Violet

```
Flat vector mascot illustration in the exact style of the "CozyWolf" brand logo. 3/4 view with the head clearly turned slightly to one side (NOT straight-on front-facing). Head and shoulders only. Cozy cartoon style with rounded soft shapes. Absolutely flat: no outlines, no gradients, no shading, no edge shadows, no rim lighting, no darker color lip at hoodie edges — only pure solid color fills. Both eyes are IDENTICAL and fully closed — each eye is a gentle symmetric curved line with a subtle upward lash tip at the outer corner. No visible pupils, no dots, no eyeballs, no open-eye elements on either side. Both eye shapes must mirror each other perfectly in size, position and curvature. Small peaceful closed-mouth smile. Character wears a chunky pullover HOODIE (NOT a coat, NOT a duffle coat, NO toggles, NO buttons, NO zippers) visible from shoulders down, with a soft rounded hood clearly visible as a fold of fabric lying flat behind the neck and shoulders. CIRCULAR BADGE COMPOSITION (critical): the character is framed as a head-and-chest portrait BUST designed to fit inside a circular badge — exactly like the CozyWolf wolf logo. The hoodie's bottom edge and the outer silhouette of the shoulders MUST curve upward at the sides to form a smooth arc that matches the lower half of an inscribed circle. The hoodie bottom is NEVER flat or horizontal — it tapers into a rounded curve whose sides rise along the circle's boundary. The character's face sits in the upper-center of the composition with a small amount of white air above the ears; the hoodie fills the lower-center and flows naturally into the circular frame. The entire character silhouette must fit inside an inscribed circle taking up the central 92 percent of the image (this circle will be the inner edge of a colored ring composited programmatically afterwards). Pure white background #FFFFFF throughout the entire square — the four corners of the square will be empty white and will sit outside the final circular frame. No ring, no circular frame, no border drawn in this image. No watermark, no signature, no text, no letters, no logo marks, no second character — single character only, centered. Highly saturated brand colors, do not desaturate, match hex codes exactly. Style must match the CozyWolf wolf logo as a sibling character. Square 1:1, 1024x1024. Koala character, saturated violet #8B5CF6 fur, big fluffy round ears, large pink heart-shaped nose, fuzzy cheeks. Wearing golden-yellow hoodie #EAB308.
```

### 6. Giraffe — Team Yellow

```
Flat vector mascot illustration in the exact style of the "CozyWolf" brand logo. 3/4 view with the head clearly turned slightly to one side (NOT straight-on front-facing). Head and shoulders only. Cozy cartoon style with rounded soft shapes. Absolutely flat: no outlines, no gradients, no shading, no edge shadows, no rim lighting, no darker color lip at hoodie edges — only pure solid color fills. Both eyes are IDENTICAL and fully closed — each eye is a gentle symmetric curved line with a subtle upward lash tip at the outer corner. No visible pupils, no dots, no eyeballs, no open-eye elements on either side. Both eye shapes must mirror each other perfectly in size, position and curvature. Small peaceful closed-mouth smile. Character wears a chunky pullover HOODIE (NOT a coat, NOT a duffle coat, NO toggles, NO buttons, NO zippers) visible from shoulders down, with a soft rounded hood clearly visible as a fold of fabric lying flat behind the neck and shoulders. CIRCULAR BADGE COMPOSITION (critical): the character is framed as a head-and-chest portrait BUST designed to fit inside a circular badge — exactly like the CozyWolf wolf logo. The hoodie's bottom edge and the outer silhouette of the shoulders MUST curve upward at the sides to form a smooth arc that matches the lower half of an inscribed circle. The hoodie bottom is NEVER flat or horizontal — it tapers into a rounded curve whose sides rise along the circle's boundary. The character's face sits in the upper-center of the composition with a small amount of white air above the ears; the hoodie fills the lower-center and flows naturally into the circular frame. The entire character silhouette must fit inside an inscribed circle taking up the central 92 percent of the image (this circle will be the inner edge of a colored ring composited programmatically afterwards). Pure white background #FFFFFF throughout the entire square — the four corners of the square will be empty white and will sit outside the final circular frame. No ring, no circular frame, no border drawn in this image. No watermark, no signature, no text, no letters, no logo marks, no second character — single character only, centered. Highly saturated brand colors, do not desaturate, match hex codes exactly. Style must match the CozyWolf wolf logo as a sibling character. Square 1:1, 1024x1024. Giraffe character, bright yellow #EAB308 coat with soft light-brown irregular patches, long slender neck emerging from the hoodie collar, small ossicones (horn-stumps) on the head, tiny dark nose. Wearing deep-purple hoodie #5B21B6.
```

### 7. Capybara — Team Red

```
Flat vector mascot illustration in the exact style of the "CozyWolf" brand logo. 3/4 view with the head clearly turned slightly to one side (NOT straight-on front-facing). Head and shoulders only. Cozy cartoon style with rounded soft shapes. Absolutely flat: no outlines, no gradients, no shading, no edge shadows, no rim lighting, no darker color lip at hoodie edges — only pure solid color fills. Both eyes are IDENTICAL and fully closed — each eye is a gentle symmetric curved line with a subtle upward lash tip at the outer corner. No visible pupils, no dots, no eyeballs, no open-eye elements on either side. Both eye shapes must mirror each other perfectly in size, position and curvature. Small peaceful closed-mouth smile. Character wears a chunky pullover HOODIE (NOT a coat, NOT a duffle coat, NO toggles, NO buttons, NO zippers) visible from shoulders down, with a soft rounded hood clearly visible as a fold of fabric lying flat behind the neck and shoulders. CIRCULAR BADGE COMPOSITION (critical): the character is framed as a head-and-chest portrait BUST designed to fit inside a circular badge — exactly like the CozyWolf wolf logo. The hoodie's bottom edge and the outer silhouette of the shoulders MUST curve upward at the sides to form a smooth arc that matches the lower half of an inscribed circle. The hoodie bottom is NEVER flat or horizontal — it tapers into a rounded curve whose sides rise along the circle's boundary. The character's face sits in the upper-center of the composition with a small amount of white air above the ears; the hoodie fills the lower-center and flows naturally into the circular frame. The entire character silhouette must fit inside an inscribed circle taking up the central 92 percent of the image (this circle will be the inner edge of a colored ring composited programmatically afterwards). Pure white background #FFFFFF throughout the entire square — the four corners of the square will be empty white and will sit outside the final circular frame. No ring, no circular frame, no border drawn in this image. No watermark, no signature, no text, no letters, no logo marks, no second character — single character only, centered. Highly saturated brand colors, do not desaturate, match hex codes exactly. Style must match the CozyWolf wolf logo as a sibling character. Square 1:1, 1024x1024. Capybara character, saturated red #DC2626 fur, blunt rounded muzzle, tiny round ears, gentle smiling expression. Wearing forest-green hoodie #166534.
```

### 8. Shiba Inu — Team Pink

```
Flat vector mascot illustration in the exact style of the "CozyWolf" brand logo. 3/4 view with the head clearly turned slightly to one side (NOT straight-on front-facing). Head and shoulders only. Cozy cartoon style with rounded soft shapes. Absolutely flat: no outlines, no gradients, no shading, no edge shadows, no rim lighting, no darker color lip at hoodie edges — only pure solid color fills. Both eyes are IDENTICAL and fully closed — each eye is a gentle symmetric curved line with a subtle upward lash tip at the outer corner. No visible pupils, no dots, no eyeballs, no open-eye elements on either side. Both eye shapes must mirror each other perfectly in size, position and curvature. Small peaceful closed-mouth smile. Character wears a chunky pullover HOODIE (NOT a coat, NOT a duffle coat, NO toggles, NO buttons, NO zippers) visible from shoulders down, with a soft rounded hood clearly visible as a fold of fabric lying flat behind the neck and shoulders. CIRCULAR BADGE COMPOSITION (critical): the character is framed as a head-and-chest portrait BUST designed to fit inside a circular badge — exactly like the CozyWolf wolf logo. The hoodie's bottom edge and the outer silhouette of the shoulders MUST curve upward at the sides to form a smooth arc that matches the lower half of an inscribed circle. The hoodie bottom is NEVER flat or horizontal — it tapers into a rounded curve whose sides rise along the circle's boundary. The character's face sits in the upper-center of the composition with a small amount of white air above the ears; the hoodie fills the lower-center and flows naturally into the circular frame. The entire character silhouette must fit inside an inscribed circle taking up the central 92 percent of the image (this circle will be the inner edge of a colored ring composited programmatically afterwards). Pure white background #FFFFFF throughout the entire square — the four corners of the square will be empty white and will sit outside the final circular frame. No ring, no circular frame, no border drawn in this image. No watermark, no signature, no text, no letters, no logo marks, no second character — single character only, centered. Highly saturated brand colors, do not desaturate, match hex codes exactly. Style must match the CozyWolf wolf logo as a sibling character. Square 1:1, 1024x1024. Shiba Inu dog character, saturated hot pink #EC4899 fur with a white muzzle and white chest-patch peeking above the hoodie collar, small triangular upright pointed ears, pointed fox-like snout, tiny black nose, hint of a curled tail behind the shoulder. Wearing sky-blue hoodie #0EA5E9.
```
