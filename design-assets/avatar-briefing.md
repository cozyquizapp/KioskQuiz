...
## 📝 Einzel-Prompts (v2.2 · ring-less · copy-paste ready)
...
`/design-lab.html` → Abschnitt „Avatar-Prompts (v2.2 · copy-paste)".
...
```
Flat vector mascot illustration in the exact style of the "CozyWolf" brand logo. 3/4 view with the head clearly turned slightly to one side (NOT straight-on front-facing). Head and shoulders only. Cozy cartoon style with rounded soft shapes. Absolutely flat: no outlines, no gradients, no shading, no edge shadows, no rim lighting, no darker color lip at hoodie edges — only pure solid color fills. Both eyes are IDENTICAL and fully closed — each eye is a gentle symmetric curved line with a subtle upward lash tip at the outer corner. No visible pupils, no dots, no eyeballs, no open-eye elements on either side. Both eye shapes must mirror each other perfectly in size, position and curvature. Small peaceful closed-mouth smile. Character wears a chunky pullover HOODIE (NOT a coat, NOT a duffle coat, NO toggles, NO buttons, NO zippers) visible from shoulders down, with a soft rounded hood clearly visible as a fold of fabric lying flat behind the neck and shoulders. Character framed as a head and chest portrait, centered on a pure white square background with generous safe-area margin on all sides — the top of the ears, the sides of the shoulders, and the bottom of the hoodie must NOT touch the image edges. The character must fit comfortably within the central 70 percent of the image. No ring, no circular frame, no border — just the isolated character on pure white (a circular ring will be composited separately afterwards). Highly saturated brand colors, do not desaturate, match hex codes exactly. Style must match the CozyWolf wolf logo as a sibling character. No text, no logo marks, square 1:1, 1024x1024. Penguin character, saturated royal blue #2563EB body and head with a white belly/chest patch peeking above the hoodie collar, small orange beak, rounded head. Wearing bright sun-yellow hoodie #FDE047.
```
...
```
Flat vector mascot illustration in the exact style of the "CozyWolf" brand logo. 3/4 view with the head clearly turned slightly to one side (NOT straight-on front-facing). Head and shoulders only. Cozy cartoon style with rounded soft shapes. Absolutely flat: no outlines, no gradients, no shading, no edge shadows, no rim lighting, no darker color lip at hoodie edges — only pure solid color fills. Both eyes are IDENTICAL and fully closed — each eye is a gentle symmetric curved line with a subtle upward lash tip at the outer corner. No visible pupils, no dots, no eyeballs, no open-eye elements on either side. Both eye shapes must mirror each other perfectly in size, position and curvature. Small peaceful closed-mouth smile. Character wears a chunky pullover HOODIE (NOT a coat, NOT a duffle coat, NO toggles, NO buttons, NO zippers) visible from shoulders down, with a soft rounded hood clearly visible as a fold of fabric lying flat behind the neck and shoulders. Character framed as a head and chest portrait, centered on a pure white square background with generous safe-area margin on all sides — the top of the ears, the sides of the shoulders, and the bottom of the hoodie must NOT touch the image edges. The character must fit comfortably within the central 70 percent of the image. No ring, no circular frame, no border — just the isolated character on pure white (a circular ring will be composited separately afterwards). Highly saturated brand colors, do not desaturate, match hex codes exactly. Style must match the CozyWolf wolf logo as a sibling character. No text, no logo marks, square 1:1, 1024x1024. Giraffe character, bright yellow #EAB308 coat with soft light-brown irregular patches, long slender neck emerging from the hoodie collar, small ossicones (horn-stumps) on the head, tiny dark nose. Wearing deep-purple hoodie #5B21B6.
```
