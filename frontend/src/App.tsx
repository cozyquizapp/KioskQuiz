...
const QQIdeasPage     = React.lazy(() => import('./pages/QQIdeasPage'));
    ...
    <AppErrorBoundary>
      <div className={isAudienceRoute ? undefined : 'cozy-app-shell'}>
        ...
        <div style={{ minHeight: '100vh', background: '#0b0d14', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <Route path="/karussell"  element={<QQCarouselPage />} />
          ...
          <Route path="/ideas"      element={<PinGate><QQIdeasPage /></PinGate>} />
          ...
          <Route path="/recap" element={<Navigate to="/stats" replace />} />
