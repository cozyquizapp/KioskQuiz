...
export function GameOverView({ state: s }: { state: QQStateUpdate; roomCode?: string }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        position: 'absolute', inset: 0, pointerEvents: 'none',
        background: `radial-gradient(ellipse at 25% 50%, ${winnerColor}28 0%, transparent 55%), radial-gradient(ellipse at 80% 90%, rgba(var(--qq-accent-magenta-rgb),0.14) 0%, transparent 50%)`,
      }} />
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              ...
              color: 'var(--qq-accent)',
              textShadow: '0 0 18px rgba(var(--qq-accent-rgb),0.45)',
            }}>
