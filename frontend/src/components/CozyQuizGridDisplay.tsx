    ...
    <div style={{ animation: shakeTick > 0 ? 'boardShake 0.45s ease-out' : undefined }} key={`shake-${shakeTick}`}>
      ...
      {jokerBurst && (
        <div key={jokerBurst.key} style={{
          ...
          {/* Callout-Banner (Text) entfernt — 2026-06-30 (Wolf 'joker text raus
              wenn joker aktiv'): keine „JOKER!"-Schrift mehr; der Effekt
              (Flash + Strahlenkranz + Shockwave-Ringe + Konfetti) feiert den
              Joker, das +1 animiert in der Rangliste. */}
