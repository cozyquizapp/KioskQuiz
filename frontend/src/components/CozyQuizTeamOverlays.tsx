...
export function HelpModal({ lang, onClose, largeMode }: { lang: 'de' | 'en'; onClose: () => void; largeMode?: boolean }) {
  ...
  const arenaItems = lang === 'de' ? [
    ...
    { icon: '🌶️', title: 'Categories', body: 'Close Call · Mu-Cho · Lucky Bag · Ten Chips · Picture This, each with its own question mechanic.' },
      ...
      <div style={{
        ...
        <div
          ...
          style={{
            ...
            border: '1px solid rgba(var(--qq-accent-rgb),0.32)',
