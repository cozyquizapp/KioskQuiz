        ...
        {!showCategory && !showRules ? (
          ...
          (() => {
            ...
            const TC_INTRO: Record<string, { emoji: string; title: { de: string; en: string }; lines: { de: string[]; en: string[] } }> = {
              ...
              ZEHN_VON_ZEHN:        { emoji: catInfo?.emoji ?? '🎰', title: { de: 'Ten Chips', en: 'Ten Chips' }, lines: { de: ['10 Punkte auf 3 Antworten verteilen'], en: ['Distribute 10 points across 3 answers'] } },
