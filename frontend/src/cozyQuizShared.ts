...
export const bt = {
  action: {
    ...
    choose1: { de: '1 Feld wählen', en: 'Choose 1 cell' },
    choose2: { de: '2 Felder wählen ({n} übrig)', en: 'Choose 2 cells ({n} left)' },
    stealDesc: { de: '1 fremdes Feld klauen', en: 'Steal 1 opponent cell' },
  ...
  comeback: {
    ...
    place2desc: { de: 'Platziere 2 freie Felder deiner Wahl', en: 'Place 2 empty cells of your choice' },
    ...
    swap2desc: { de: 'Tausche je ein Feld von zwei Gegnern', en: 'Swap 1 cell each of two opponents' },
    chosenPlace2: { de: '📍 2 Felder werden gesetzt…', en: '📍 Placing 2 cells…' },
    chosenSteal1: { de: '⚡ 1 Feld wird geklaut…', en: '⚡ Stealing 1 cell…' },
    chosenSwap2: { de: '🔄 Felder werden getauscht…', en: '🔄 Swapping cells…' },
  },
  grid: { label: { de: 'Feld', en: 'cell' } },
  gameOver: {
