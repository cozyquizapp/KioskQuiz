      ...
      >
        ...
        >
          <button
            ...
            onClick={() => doAction(() => startNextQuestion(roomCode), 'Nächste Frage')}
          >
            Nächste Frage
          </button>
          <button
      ...
      <section style={card}>
          ...
          <div>
            ...
            {meta?.globalIndex != null && (
              <div style={{ fontSize: 12, color: '#94a3b8' }}>
                {meta.globalIndex}/{meta.globalTotal} · {meta.categoryKey}
              </div>
            )}
          </div>
        </div>
        ...
        <div style={{ marginTop: 12, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <button
            ...
            onClick={() => {
              if (window.confirm('Nächste Frage starten?')) doAction(() => startNextQuestion(roomCode), 'Nächste Frage');
            }}
          >
            Nächste Frage
          </button>
        ...
        <div style={{ marginTop: 10, display: 'grid', gridTemplateColumns: '1fr', gap: 8 }}>
          ...
          <button
            ...
            onClick={() => {
              ...
              if (!window.confirm(`Kategorie-Intro für ${categoryIntroId} auslösen?`)) return;
              ...
              if (candidate) {
                ...
                setToast('Keine Frage für diese Kategorie gefunden');
                setTimeout(() => setToast(null), 2000);
              }
            }}
          >
