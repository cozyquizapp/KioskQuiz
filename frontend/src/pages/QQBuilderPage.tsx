...
// 2026-05-25 (Wolf 'bluff und imposter ausgeblendet, Code bleibt fuer
// spaeter-Reaktivierung'): Beide UI-unsichtbar. Bluff war seit 2026-05-23
      ...
      <div style={{ marginBottom: 32, display: 'flex', alignItems: 'flex-end', gap: 24, flexWrap: 'wrap' }}>
        <div style={{ flex: 1, minWidth: 280 }}>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            <button onClick={() => { window.location.href = '/ideas'; }} style={{ ...brandCreateBtn(true), display: 'flex', alignItems: 'center', gap: 6 }}>✦ Ideen-Inbox</button>
