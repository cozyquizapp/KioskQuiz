...
export const QQ_BEAMER_CSS = `
  ...
  /* CozyGuessr: die Ortsnamen kommen erst, wenn das Ziel steht. Sanft, damit
     sich die Karte nicht schlagartig fuellt. Leaflet setzt auf seine Kachel-
     Ebenen selbst opacity, deshalb liegt die Blende auf einer Animation und
     nicht auf einem Uebergang. */
  @keyframes qqKartenNamenAn { from{opacity:0} to{opacity:1} }
  .qq-karten-namen { animation: qqKartenNamenAn 0.9s var(--qq-ease-smooth) both; }
