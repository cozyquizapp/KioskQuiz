...
export const COZY_SLOT_TEMPLATE: CozyQuestionSlotTemplate[] = [
  ...
  { index: 1, segmentIndex: 0, type: 'SCHAETZCHEN', defaultPoints: 1, label: 'Slot 2 - Schaetzfrage' },
  ...
  { index: 9, segmentIndex: 0, type: 'SCHAETZCHEN', defaultPoints: 1, label: 'Slot 10 - Schaetzfrage' },
  ...
  { index: 14, segmentIndex: 1, type: 'SCHAETZCHEN', defaultPoints: 2, label: 'Slot 15 - Schaetzfrage' },
  ...
  { index: 18, segmentIndex: 1, type: 'SCHAETZCHEN', defaultPoints: 2, label: 'Slot 19 - Schaetzfrage' },
